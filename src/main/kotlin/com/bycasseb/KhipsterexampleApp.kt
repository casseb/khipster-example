package com.bycasseb

import com.bycasseb.config.ApplicationProperties
import com.bycasseb.config.addDefaultProfile
...
class KhipsterexampleApp(private val env: Environment) : InitializingBean {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes khipsterexample.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<KhipsterexampleApp>(*args) { addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(KhipsterexampleApp::class.java)
